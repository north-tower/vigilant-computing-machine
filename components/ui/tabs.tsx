...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex items-center justify-center gap-1.5 rounded-md px-4 py-1.5 text-sm font-medium whitespace-nowrap text-text-muted transition-all hover:text-text focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 text-sm outline-none animate-in fade-in duration-300", className)}
      {...props}
    />
  )
}
